...
async def task3_demo():
    ...
    print("1️⃣ Placing Order to Create Position")
    print("-" * 40)
    ...
    print(f"\n5️⃣ JSON Output for API Integration")
    print("-" * 40)
